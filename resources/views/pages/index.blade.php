        ...
        <div class="owl-carousel owl-theme blog-slider">
          ...
          <div class="card blog__slide text-center">
            <div class="blog__slide__img">
              <img style="height:350px" class="card-img rounded-0" src="categoryImages/{{$category->image}}" alt="">
            </div>
            <div class="blog__slide__content">
              <a class="blog__slide__label" href="{{ route('categories.show',$category->id) }}">{{$category->category_name}}</a>
              <h3><a href="{{ route('categories.show',$category->id) }}">{{ $category->description }}</a></h3>
            </div>
          </div>
